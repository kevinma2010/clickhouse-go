# ClickHouse [![run-tests](https://github.com/kevinma2010/clickhouse-go/actions/workflows/run-tests.yml/badge.svg?branch=v2)](https://github.com/kevinma2010/clickhouse-go/actions/workflows/run-tests.yml) [![Go Reference](https://pkg.go.dev/badge/github.com/kevinma2010/clickhouse-go/v2.svg)](https://pkg.go.dev/github.com/kevinma2010/clickhouse-go/v2)
...
| [V2 (READ) std](benchmark/v2/read/main.go) | [V2 (READ) native](benchmark/v2/read-native/main.go) |
| ------------------------------------------ | ---------------------------------------------------- |
| 924.390ms                                  | 675.721ms                                            |


| [V2 (WRITE) std](benchmark/v2/write/main.go) | [V2 (WRITE) native](benchmark/v2/write-native/main.go) | [V2 (WRITE) by column](benchmark/v2/write-native-columnar/main.go) |
| -------------------------------------------- | ------------------------------------------------------ | ------------------------------------------------------------------ |
